...
export const eventTypeEnum = z.enum([
  ...
  EVENT_TYPES.ENQUIRY_FORM_VIEW,
  EVENT_TYPES.ENQUIRY_FORM_START,
  EVENT_TYPES.ENQUIRY_FORM_SUBMIT,
  EVENT_TYPES.ENQUIRY_VALIDATION_ERROR,
  EVENT_TYPES.ADDON_VIEW,
  EVENT_TYPES.ADDON_SELECT,
]);
