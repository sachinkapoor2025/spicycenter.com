...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    "Stop daily emails about unpaid SpicyCenter checkout orders. You will still receive order updates after payment.",
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-14">
      ...
      <p className="text-slate-600 text-sm leading-relaxed mb-8">
        Enter the email address that receives daily reminders about an unpaid SpicyCenter order. We will stop
